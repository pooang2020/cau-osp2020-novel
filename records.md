...
+ pooang2020
  - [전개:소설] 01 이 세계에 대해 기대하는 제리 표현
  - [전개:삽화] 02 배고픈 톰의 이미지를 추가
  - [위기:소설] 01 제리가 잡혀가는 내용 추가
  - [위기:삽화] 02 톰과 대장바퀴와의 대화 이미지 추가
  - [절정:소설] 01 마녀와 톰의 대화를 추가
  - [절정:삽화] 02 톰이 구슬속의 동물들을 꺼내주는 이미지 추가
  - [결말:소설] 01 목욕 하러 가는 톰과 제리 모습 추가
  - [결말:삽화] 02 집사에게 잡힌 제리 이미지 추가
  - [결말:정정] 03 중복된 내용 삭제
  - [결말:정정] 04 자연스러운 배치로 삽화 위치 수정
